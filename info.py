...
BOT_TOKEN = environ.get('BOT_TOKEN', "6843833325:AAF5ep_G-c-6fz4zdoXOIY5rsR9WyBLqU-E")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/5876f43b347e9fd0125b5.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://te.legra.ph/file/a27dc8fe434e6b846b0f8.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_Linkl")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6141937812').split()]
...
URL = "https://demo-gsmz.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movie.pandawep.in".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie.pandawep.in".format(FQDN)
else:
    URL = "https://movie.pandawep.in".format(FQDN)
