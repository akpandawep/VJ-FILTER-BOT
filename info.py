...
API_ID = int(environ.get('API_ID', '20006068'))
API_HASH = environ.get('API_HASH', '346becfc02417e50a2837a8d545b015e')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/PandaMovieReq')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/PandaWep')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/PandaWep')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001623633000'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'PandaWepChat')
...
URL = "https://vip.ashu.pandawep.in".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vip.ashu.pandawep.in/".format(FQDN, PORT)
